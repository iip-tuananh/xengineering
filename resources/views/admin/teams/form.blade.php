                ...
                <div class="form-group custom-group">
                    <div class="row gx-3 gy-2">
                        <div class="col-6 col-md-3">
                            ...
                            <input class="form-control" type="text" ng-model="form.facebook" placeholder="Facebook URL">
                        </div>
                        <div class="col-6 col-md-3">
                            <label class="form-label">Instagram</label>
                            <input class="form-control" type="text" ng-model="form.ins" placeholder="Instagram URL">
                        </div>
                        <div class="col-6 col-md-3">
                            <label class="form-label">Twitter</label>
                            <input class="form-control" type="text" ng-model="form.tw" placeholder="Twitter URL">
                        </div>
                        <div class="col-6 col-md-3">
                            <label class="form-label">Pinterest</label>
                            <input class="form-control" type="text" ng-model="form.pri" placeholder="Pinterest URL">
                        </div>
                    </div>
                </div>
            </div>
