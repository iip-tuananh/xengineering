...
<div class="row">
    <div class="col-sm-8">
        <div class="form-group custom-group mb-4">
            <label class="form-label required-label">Tên trải nghiệm</label>
        ...
        <div class="form-group custom-group mb-4">
            <label class="form-label required-label">Tên trải nghiệm (Tiếng Anh)</label>
        ...
        <div class="form-group custom-group mb-4">
            ...
            <textarea class="form-control ck-editor" ck-editor rows="5" ng-model="form.body_eng"></textarea>
            <span class="invalid-feedback d-block" role="alert">
                <strong>
                    <% errors.body_eng[0] %>
                </strong>
