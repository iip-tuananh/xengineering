    ...
    <div class="col-md-8 col-sm-8 col-xs-12">
        ...
        <div class="tab-content" id="myTabContent1">
            <div class="tab-pane fade show active p-3" id="vi" role="tabpanel" aria-labelledby="vi-tab">
                ...
                <div class="form-group custom-group mb-4">
                    <label class="form-label required-label">Intro</label>
                    <textarea id="editor" class="form-control" ck-editor ng-model="form.intro" rows="5"></textarea>
                    <span class="invalid-feedback d-block" role="alert">
            ...
            <div class="tab-pane fade show p-3" id="en" role="tabpanel" aria-labelledby="en-tab">
                ...
                <div class="form-group custom-group mb-4">
                    <label class="form-label required-label">Intro</label>
                    <textarea id="editor" class="form-control" ck-editor ng-model="form.intro_eng" rows="5"></textarea>
                    <span class="invalid-feedback d-block" role="alert">
