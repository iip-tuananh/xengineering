...
@section('page_title')
    Danh sách tư liệu truyền thông
@endsection
...
@section('buttons')
    @if(Auth::user()->type == App\Model\Common\User::QUAN_TRI_VIEN || Auth::user()->type == App\Model\Common\User::SUPER_ADMIN)
        <a href="{{ route('document.create') }}" class="btn btn-outline-success btn-sm" class="btn btn-info"><i
...
@section('script')
    ...
    <script>
        let datatable = new DATATABLE('table-list', {
            ...
            search_columns: [
                {data: 'title', search_type: "text", placeholder: "Tên tư liệu"},
            ],
            act: true,
        }).datatable;
