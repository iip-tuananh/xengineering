<div class="modal fade" id="create-service" tabindex="-1" role="dialog" aria-hidden="true"
     ng-controller="CreateServiceSpa">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="semi-bold">Thêm dịch vụ</h4>
            </div>
...
<script>
    app.controller('CreateServiceSpa', function ($scope, $http) {
        $scope.form = new ServiceSpa({}, {scope: $scope});
        $scope.loading = {};


        // Submit Form tạo mới
        $scope.submit = function () {
            let url = "{!! route('ServiceSpa.store') !!}";;
