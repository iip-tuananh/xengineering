            ...
            <div class="row">
                <div class="col-lg-6 ft-contact">
                    ...
                    <ul>
                        ...
                        <li>
                            <a target="_blank" href="{{ $config->facebook }}" title="Facebook">
                        ...
                        <li>
                            <a target="_blank" href="{{ $config->twitter }}" title="Twitter">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <li>
                            <a target="_blank" href="{{ $config->youtube }}" title="Youtube">
                        ...
                        <li>
                            <a target="_blank" href="{{ $config->instagram }}" title="Instagram">
                ...
                <div class="col-lg-6 ft-mailchimp">
                    ...
                    <form id="mc-form" class="newsletter-form" data-toggle="validator">
                        <input aria-label="Địa chỉ Email" type="email" class="form-control"
                               placeholder="Nhập email nhận tin" name="EMAIL" required autocomplete="off"/>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3 ft-info col-footer">
                    ...
                    <a href="{{ route('front.home-page') }}" class="logo-ft" title="Logo">
                ...
                <div class="col-12 col-md-6 col-lg-2 link-list col-footer">
                    ...
                    <ul class="list-menu">
                        ...
                        <li><a href="{{ route('front.abouts') }}" title="Giới thiệu">Giới thiệu</a></li>



                        <li><a href="{{ route('front.services') }}" title="Dịch vụ">Dịch vụ</a></li>
                        <li><a href="{{ route('front.getProductList') }}" title="Sản phẩm">Sản phẩm</a></li>
                        <li><a href="{{ route('front.projects') }}" title="Dự án">Dự án</a></li>
                        <li><a href="{{ route('front.blogs') }}" title="Dự án">Tin tức</a></li>
                    ...
                    @foreach($posts as $post)
                        <div class="item-blog-ft">
                            <div class="block-thumb">
                                ...
                                <a class="thumb" href="{{ route('front.blogDetail', $post->slug) }}"
                                   title="{{ $post->name }}">
                            ...
                            <div class="block-content">
                                ...
                                <h3>
                                    <a class="line-clamp line-clamp-2" href="{{ route('front.blogDetail', $post->slug) }}"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-12">
                    <span class="copy-right">Bản quyền thuộc về <b>{{ $config->short_name_company }}</b></span><span
                        class="d-none d-sm-inline-block"><b>.</b></span>
                </div>
