...
use App\Model\Admin\CloudPool as ThisModel;
...
class CloudPoolController extends Controller
{
    protected $view = 'admin.cloudpool';
    protected $route = 'CloudPool';
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            if(!$object) $object = new CloudPool();
            ...
            foreach ($request->blocks as $block) {
                $objBlock = Block::query()->where('code', $block['code'])
                    ...
                    ->where('blockable_type', CloudPool::class)
                    ->first();
                ...
                $objBlock->code = $block['code'] ?? null;
                $objBlock->blockable_id = $object->id;
                $objBlock->blockable_type = CloudPool::class;
                $objBlock->save();
