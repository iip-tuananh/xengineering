...
use App\Model\Admin\TermDetail;
use Illuminate\Http\Request;
use App\Model\Admin\Term as ThisModel;
...
class TermController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $object->content_eng = $request->content_eng;

            TermDetail::query()->delete();
            foreach ($request->details as $d) {
                $detail = new TermDetail();
                $detail->term_id = $object->id;
